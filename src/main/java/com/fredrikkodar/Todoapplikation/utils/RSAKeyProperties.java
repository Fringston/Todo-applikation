...
public class RSAKeyProperties {
    ...
    //Konstruktor som genererar ett RSA-nyckelpar med hjälp av KeyGeneratorUtility. Den offentliga och privata nyckeln extraheras och lagras i de motsvarande fälten.
